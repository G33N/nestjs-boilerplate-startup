...
- [x] Loggs with pino and better stack.
...
## CI/CD
The application is deployed in elastick beanstalk using S3. 

If you need to generate the infrastructure, see the infrastructure project in terraform. Comming soon
